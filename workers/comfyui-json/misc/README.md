...
**`VAST_WORKLOAD_UNITS`** overrides `workload_calculator` for that instance. Full policy, calibration, and bot vs routing load: **`comfy-vast-serverless/docs/VAST_BENCHMARK_LANES_AND_BOT_COST.md`** (monorepo root).
