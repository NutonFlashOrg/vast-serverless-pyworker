...
| `I2V_5090_PAID` | `benchmark_I2V_5090_15SEC.json` | 5090 **paid-pool** template lane (boot benchmark). Template env carries **`VAST_WORKLOAD_UNITS_I2V_5090_{5,10,15}SEC`** (same trio as the free-pool template — bot routes any lane to free vs paid by `balance_type` only). |
