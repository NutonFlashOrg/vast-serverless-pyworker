...
- **Custom benchmark**: Uses `VAST_BENCHMARK_WORKFLOW_PATH` with optional S3-backed input image.
...
- `BENCHMARK_IMAGE_BUCKET`, `BENCHMARK_IMAGE_KEY`, `BENCHMARK_IMAGE_TITLE` — optional benchmark input image
